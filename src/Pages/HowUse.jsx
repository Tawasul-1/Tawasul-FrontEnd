        ...
        <div className=" text-center">
          <div className="howuse-header-section">
            ...
            <div className="howuse-section text-start mb-4">
              <p>
                ...
                displayed on a screen (tablet/mobile/interactive device), and the child learns to
                press the right picture to ask or communicate.
              </p>
              <p>
          ...
          <div className="howuse-stages container mt-5">
            ...
            <div className="stage mb-5" data-step="1">
              ...
              <p>
                <strong>Goal:</strong> The child learns that pressing the picture of something they
                want = they get it immediately.
              </p>
              <ul>
                <li>
                  Show one picture on the screen of something the child really likes (e.g., juice,
                  toy, biscuit).
                </li>
                <li>
                  When the child reaches for the real item, guide them to press the picture on the
                  screen instead.
                </li>
            ...
            <div className="stage mb-5" data-step="2">
              ...
              <p>
                <strong>Goal:</strong> The child learns to go to the screen on their own when they
                want something.
              </p>
              <ul>
            ...
            <div className="stage mb-5" data-step="3">
              ...
              <p>
                <strong>Goal:</strong> The child learns to pick the correct picture from multiple
                options.
              </p>
            ...
            <div className="stage mb-5" data-step="5">
              ...
              <p>
                <strong>Goal:</strong> The child can answer “What do you want?” using the screen.
              </p>
              <ul>
