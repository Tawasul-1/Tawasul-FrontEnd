          ...
          <section className="container py-5 d-flex flex-column flex-md-row align-items-center gap-4">
            <div className="col-md-6">
              ...
              <p className="text-secondary" style={{ fontSize: "1.25rem", fontWeight: 500 }}>
                TawasuL is a visual communication platform designed to support non-speaking
                children, especially those with autism. It uses PECS-based tools to help them
                express needs, feelings, and thoughts with ease and confidence.
              </p>
              <p className="text-secondary" style={{ fontSize: "1.25rem", fontWeight: 500 }}>
